        ...
        <div class="col-12">
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <a href="index.php" class="btn btn-primary mb-4">Back to Home</a>
                    <h2 class="mb-4">Top Fashion Posts</h2>
                    ...
                    <div class="row">
                        ...
                        // Fetch top business posts (for example, the most recent or most viewed)
                        $topCategory = 'Fashion'; // Change this to fetch different categories
    ...
    <div class="col-12">
        <nav aria-label="Page navigation">
            <ul class="pagination justify-content-center">
                ...
                <?php
                // Displaying page numbers with some limits
                $pageLimit = 2; // Number of pages to show before and after the current page
