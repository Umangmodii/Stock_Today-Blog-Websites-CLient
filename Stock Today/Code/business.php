        ...
        <div class="col-12">
            ...
            <div class="tab-content" id="nav-tabContent">
                ...
                <div class="tab-pane fade show active" id="nav-business" role="tabpanel" aria-labelledby="nav-business-tab">
                    <h2 class="mb-4">Top Business Posts</h2>
                    <div class="row">
                        <?php
                        include 'Admin_Panel/Database/db_connection.php';
                       
                        $topCategory = 'Business'; 
                        $topSql = "SELECT id, title, image, author, published_date FROM posts WHERE category = ? ORDER BY published_date DESC LIMIT 3"; // Fetching top 3 posts
